...
import src.Classes.ClassesForInAndOut;
import src.Classes.InputArgs;
import src.Classes.MainLogicTask;
import src.Classes.Test;
...
import static src.Classes.MainLogicTask.printSuccessMessage;
import static src.Classes.MainLogicTask.readAndWriteMethod;
...
public class FrameMain extends JFrame{
    ...
    public FrameMain() throws IOException {
        ...
        ImageIcon img = new ImageIcon("1.jpg"); //СТАВЛЮ КАРТИНКУ В ПРОГУ
        ...
        writeFileBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                //обработка массива
                try {
                    answer = MainLogicTask.massivVStroki(MainLogicTask.getAnswer(JTableUtils.readIntMatrixFromJTable(table1)));
